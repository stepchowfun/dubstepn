Rails.application.routes.draw do
  ...
  # admin panel
  get "/admin/index" => "home#admin"
  get "/admin/edit_post/:post_id" => "home#edit_post", :format => false
  post "/admin/create_post" => "home#create_post_action"
  post "/admin/move_up" => "home#move_up_action"
  post "/admin/move_down" => "home#move_down_action"
  post "/admin/move_top" => "home#move_top_action"
  post "/admin/move_bottom" => "home#move_bottom_action"
  post "/admin/edit_post" => "home#edit_post_action"
  post "/admin/delete_post" => "home#delete_post_action"
  post "/admin/create_redirect" => "home#create_redirect_action"
  post "/admin/delete_redirect" => "home#delete_redirect_action"

  # authentication
  get "/admin/login" => "home#login"
  post "/admin/login" => "home#login_action"
  post "/admin/logout" => "home#logout_action"
